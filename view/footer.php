        ...
        <div class="container">
            <div class="footer_top">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6" style="text-align: left;">
            ...
            <div class="footer_bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright_area" style="text-align: left;">
                            <p>Copyright &copy; 2023 <a href="#">Autima</a> All Right Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
...
<!-- Mirrored from htmldemo.net/autima/autima/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Nov 2023 11:02:54 GMT -->
</html>
</div>
<script>
    let slideIndex = 0;
